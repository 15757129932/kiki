...
$(function() {
    var GridView = function(el, option) {
        ...
        //this.$filterbar = $(this.$table.data('filterbar'));
        //this.$form = this.$toolbar.find('.edit-form, .search-form');
        this.$form = $(this.$table.data('filterbar'));
        this.$counterbar = $(this.$table.data('counterbar'));
        ...
        this.sidePagination = this.$table.data('sidePagination') == 'client' ? 'client' : 'server';
    ...
    GridView.prototype.resetCounterBar = function(data) {
        if(this.$counterbar){
        	for (var item in data){
        		var target = this.$counterbar.find("[data-field='" + item + "']");
