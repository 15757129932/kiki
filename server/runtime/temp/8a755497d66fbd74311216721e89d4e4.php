                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($vo['h_layer'] == 1): else: $__FOR_START_1658731925__=1;$__FOR_END_1658731925__=$vo['h_layer'];for($i=$__FOR_START_1658731925__;$i < $__FOR_END_1658731925__;$i+=1){ ?>　　　<?php } ?>├
                                <?php endif; ?>
