<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:70:"/var/www/html/obm/public/../application/admin/view/guestbook/edit.html";i:1520564784;s:67:"/var/www/html/obm/public/../application/admin/view/public/base.html";i:1520564784;s:75:"/var/www/html/obm/public/../application/admin/view/public/admin_load_t.html";i:1520564784;s:72:"/var/www/html/obm/public/../application/admin/view/public/admin_top.html";i:1520564784;s:73:"/var/www/html/obm/public/../application/admin/view/public/admin_left.html";i:1520564784;s:75:"/var/www/html/obm/public/../application/admin/view/public/admin_bottom.html";i:1520564784;s:75:"/var/www/html/obm/public/../application/admin/view/public/admin_load_b.html";i:1520564784;}*/ ?>
...
<section class="content-header">
    <h1>留言信息</h1>
    <ol class="breadcrumb">
        <li class="active"><i class="fa fa-dashboard"></i> 留言信息</li>
    </ol>
</section>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('tel'); ?></label>
                                <div class="col-sm-7"><input class="form-control" name="tel" value="<?php echo $data['tel']; ?>" placeholder="<?php echo \think\Lang::get('tel'); ?>"></div>
                            </div>
                               <div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo \think\Lang::get('company'); ?></label>
                                <div class="col-sm-7"><input class="form-control" name="company" value="<?php echo $data['company']; ?>" placeholder="<?php echo \think\Lang::get('company'); ?>"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"><textarea class="form-control" style="resize:none;height:155px;" name="content" placeholder="<?php echo \think\Lang::get('content'); ?>"><?php echo $data['content']; ?></textarea></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control select2" name="status" style="width:100%;">
                                        <option value="1" <?php if($data['status'] == '1'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('status3'); ?></option>
                                        <option value="0" <?php if($data['status'] == '0'): ?>selected="selected"<?php endif; ?> ><?php echo \think\Lang::get('status2'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
